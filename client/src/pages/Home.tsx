...
const thumbnails: Record<string, string> = {
  "Subway Surfers": "/manus-storage/pixel-jogos-subway-surfers-real_639bcc43.svg",
  "Age of War": "/manus-storage/pixel-jogos-age-of-war-real_91d544ea.svg",
  "Henry Stickmin": "/manus-storage/pixel-jogos-henry-stickmin-real_889081af.svg",
  "Super Mario 63": "/manus-storage/pixel-jogos-super-mario-63-real_dacb6df2.svg",
  "Super Smash Flash": "/manus-storage/pixel-jogos-super-smash-flash-real_751a8673.svg",
  "Sonic Flash": "/manus-storage/pixel-jogos-sonic-flash-real_40669d14.svg",
  "Portal: Flash Version": "/manus-storage/pixel-jogos-portal-real_2a78fd71.svg",
  "Bloons TD": "/manus-storage/pixel-jogos-bloons-td-real_c4ad891a.svg",
  ...
  "Storm the House": "/manus-storage/pixel-jogos-storm-the-house-real_317ca1d5.svg",
  "Storm the House 2": "/manus-storage/pixel-jogos-storm-the-house-2-specific_2fb7b738.svg",
  "Dad N Me": "/manus-storage/pixel-jogos-dad-n-me-real_963f4a6a.svg",
  "Commando": "/manus-storage/pixel-jogos-commando-real_c855f273.svg",
  "Commando 2": "/manus-storage/pixel-jogos-commando-2-specific_b72905cf.svg",
  "Doom": "/manus-storage/pixel-jogos-doom-real_a37fe7b4.svg",
  "Duck Life": "/manus-storage/pixel-jogos-duck-life-real_e28d36da.svg",
  "Duck Life 2": "/manus-storage/pixel-jogos-duck-life-2-real_ef54475d.svg",
  "Duck Life 3": "/manus-storage/pixel-jogos-duck-life-3-real_720d188e.svg",
  "Duck Life 4": "/manus-storage/pixel-jogos-duck-life-4-real_08863968.svg",
  "Learn to Fly": "/manus-storage/pixel-jogos-learn-to-fly-real_108f446b.svg",
  "Motherload": "/manus-storage/pixel-jogos-motherload-real_568876ac.svg",
  "Bloxorz": "/manus-storage/pixel-jogos-bloxorz-real_899af4e8.svg",
  "The Impossible Quiz": "/manus-storage/pixel-jogos-the-impossible-quiz-real_da01c6cd.svg",
  "World's Hardest Game": "/manus-storage/pixel-jogos-worlds-hardest-game-real_a289ba4f.svg",
  "Riddle School": "/manus-storage/pixel-jogos-riddle-school-real_9f7f5701.svg",
  ...
  "Shopping Cart Hero": "/manus-storage/pixel-jogos-shopping-cart-hero-real_a7e8ac99.svg",
  "Interactive Buddy": "/manus-storage/pixel-jogos-interactive-buddy-real_aac78fcb.svg",
  "N": "/manus-storage/pixel-jogos-n-specific_3d23a3f2.svg",
  "Tetris": "/manus-storage/pixel-jogos-tetris-real_0a83db4d.svg",
  "Pac-Man": "/manus-storage/pixel-jogos-pac-man-real_a8a38012.svg",
  "Fancy Pants": "/manus-storage/pixel-jogos-fancy-pants-real_657d76dd.svg",
...
export default function Home() {
  ...
  const loginMutation = trpc.auth.login.useMutation({
    onSuccess: async user => {
      if (typeof window !== "undefined" && window.top !== window.self && user.sessionToken) {
        storeEmbeddedSessionToken(user.sessionToken);
      }
