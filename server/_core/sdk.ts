...
class SDKServer {
  ...
  async authenticateRequest(req: Request): Promise<AuthenticatedUser> {
    ...
    // Manus sessions may need to be synchronized from the OAuth service.
    // Local email/password sessions already exist in our database and should
    // never be sent to the Manus OAuth API.
